...
public class Loading_OrientMind : MonoBehaviour
{
	//[FormerlySerializedAs("loading")]
	public Slider loading_OrientMind;
	//[FormerlySerializedAs("onFinish")]
	public UnityEvent onFinish_OrientMind;

	public void TriggerLoading_OrientMind()
	{

		loading_OrientMind.DOValue(1, 4).OnComplete(() =>
		{
			onFinish_OrientMind?.Invoke();
		});
