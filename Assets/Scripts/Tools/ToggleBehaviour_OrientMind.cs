...
public class ToggleBehaviour_OrientMind : MonoBehaviour
{
	public UnityEvent<bool> on_OrientMind, off_OrientMind, toggle_changed_OrientMind;


	public bool value_OrientMind;

	public void Toggle_OrientMind()
	{
		value_OrientMind = !value_OrientMind;
		ValueChanged_OrientMind();
	...
	public bool GetValue_OrientMind()
	{
		return value_OrientMind;
	...
	public void SetValue_OrientMind(bool value)
	{
		this.value_OrientMind = value;
		ValueChanged_OrientMind();
	...
	private void ValueChanged_OrientMind()
	{
		if (value_OrientMind)
		{
			on_OrientMind.Invoke(value_OrientMind);
		}
		else
		{
			off_OrientMind.Invoke(value_OrientMind);
		}
		toggle_changed_OrientMind?.Invoke(value_OrientMind);
